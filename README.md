...
Below are example attribution maps generated by Libra-CAM and prior methods on representative samples.

<p align="center">
  <img src="Results/result2.png" width="950"/>
  <br/>
  <em>Figure: Qualitative comparison on ImageNet. Libra-CAM produces more focused and interpretable attributions.</em>
</p>

<p align="center">
  <img src="Results/result1.png" width="950"/>
  <br/>
  <em>Figure: Qualitative comparison on Pascal VOC. Libra-CAM better aligns with class-discriminative regions.</em>
</p>
